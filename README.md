[![Build status](https://ci.appveyor.com/api/projects/status/1xtufwit880vmynr?svg=true)](https://ci.appveyor.com/project/DmitriyRonMan/patterns1-2)
...
* Время, затраченное на автоматизацию (часов): 6